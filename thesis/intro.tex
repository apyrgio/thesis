...
The motivation for this thesis emerged from the performance limitations that we 
have encountered during the development of the Synnefo
...
Research community. It is a production-ready project that has been in 
development since 2011 by GRNET S.A.
\footnote{Greek Research and Technology Network, https://www.grnet.gr/}

Synnefo on the other hand is the cloud software stack that implements the 
following services which are used by \okeanos:
...
This thesis will deal exclusively with the Storage Service of Synnefo and more 
...
a replicated object storage (see more in Section ?) that was using hard disks, 
we concluded that this was the main reason behind the performance issues of 
Archipelago and decided to implement a caching system that would use a much 
