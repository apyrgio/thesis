...
Similarly to xcache, we will begin by examining the top-level function and then 
we present how blabla were solved.
...
and the cached structure that is initialized is the following:
...
cached can create its own entries, which are as many as the object size. The 
