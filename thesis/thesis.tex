...
\title{Implementation of an In-memory Cache with O(1) Average-case Complexity 
	for a Distributed Storage Service} 
...
\hypersetup{
	pdftitle={Implementation of an in-memory cache with O(1) average-case 
		complexity for a distributed storage serviceThesis subject},
	pdfauthor={Αλέξιος Πυργιώτης},
	pdfsubject={},
	pdfkeywords={}
}
