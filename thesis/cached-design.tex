...
To achieve the above, cached extends its repertoire using some unique 
structures, namely:
...
We will illustrate the design of cached in Figure \ref{fig:cached-design.pdf} 
and we will further explain how it handles the above in the following sections.
...
requests too such as copy requests (send when an object is copied-on-write) and 
